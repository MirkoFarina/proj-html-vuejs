<script>
import SliderCoach from './SliderCoach.vue';
export default {
    name: 'TemplateCoach',
    components: {
        SliderCoach
...
<template>
    <div class="container position-relative">
        <div class="wave position-absolute">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="#f6f6f6" version="1.1" preserveAspectRatio="none" width="100%" height="780px">
        ...
        <SliderCoach :arrayCards="dataCards" class="mb-5" />
